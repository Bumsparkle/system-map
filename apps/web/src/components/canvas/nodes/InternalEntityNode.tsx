...
/** A team/department/person inside the company — the solid-border counterpart to
 *  the dashed External entity node (outside the boundary). */
export function InternalEntityNode({ id, data, selected }: NodeProps<SMNode>) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        {custom ?? <UsersRound className="h-4 w-4 shrink-0 text-ink-muted" />}
