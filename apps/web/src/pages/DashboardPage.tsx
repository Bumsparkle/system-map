...
import type { Company } from '@system-map/shared'
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {diagrams.data?.map((diagram) => (
          <button
            ...
            className="group flex flex-col gap-2 rounded-[10px] border border-border bg-surface p-4 text-left transition-[border-color,box-shadow] duration-[120ms] ease-out hover:border-border-strong hover:shadow-node focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
          >
            <span className="font-medium text-ink">{diagram.name}</span>
